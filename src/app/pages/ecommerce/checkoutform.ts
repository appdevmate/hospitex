                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-12 mb-12">
                            ...
                            <div class="flex items-center">
                                <p-checkbox name="checkbox-1" [(ngModel)]="checked" [binary]="true" inputId="id" [style]="{display:'contents'}" ></p-checkbox>
                        ...
                        <div class="col-span-12 lg:col-span-6 mb-6">
                            <div class="flex items-center">
                                <p-checkbox name="checkbox-2" [(ngModel)]="checked2" [binary]="true" inputId="id" [style]="{display:'contents'}" ></p-checkbox>
