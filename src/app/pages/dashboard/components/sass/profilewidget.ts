    ...
    template: ` <div class="card">
        ...
        <ul class="list-none p-0 m-0">
            <li class="mb-6 flex items-center justify-start">
                <p-avatar icon="pi pi-user-edit" size="large" shape="circle" styleClass="flex-shrink-0 text-base font-bold" [style]="{ 'background-color': 'rgba(250, 219, 95, 0.1)', color: '#DE911D', border: '1px solid #FADB5F' }"></p-avatar>
                <div class="ml-6">
            ...
            <li class="mb-6 flex items-center justify-start">
                <p-avatar icon="pi pi-send" size="large" shape="circle" styleClass="flex-shrink-0 text-base font-bold" [style]="{ 'background-color': 'rgba(250, 219, 95, 0.1)', color: '#DE911D', border: '1px solid #FADB5F' }"></p-avatar>
                <div class="ml-6">
            ...
            <li class="mb-6 flex items-center justify-start">
                <p-avatar icon="pi pi-video" size="large" shape="circle" styleClass="flex-shrink-0 text-base font-bold" [style]="{ 'background-color': 'rgba(250, 219, 95, 0.1)', color: '#DE911D', border: '1px solid #FADB5F' }"></p-avatar>
                <div class="ml-6">
            ...
            <li class="mb-6 flex items-center justify-start">
                <p-avatar icon="pi pi-briefcase" size="large" shape="circle" styleClass="flex-shrink-0 text-base font-bold" [style]="{ 'background-color': 'rgba(250, 219, 95, 0.1)', color: '#DE911D', border: '1px solid #FADB5F' }"></p-avatar>
                <div class="ml-6">
