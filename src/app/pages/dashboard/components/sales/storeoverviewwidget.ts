...
@Component({
    ...
    template: ` <div class="card h-full">
        ...
        <div class="flex items-center mt-16 rounded-border">
            <div class="flex flex-col items-center flex-1 py-6 cursor-pointer border-t hover:bg-emphasis" [ngClass]="{ 'border-primary-500': activeTab === 0, 'surface-border': activeTab !== 0 }" (click)="onTabClick(0)">
                <i class="pi pi-sort-amount-down text-2xl mb-2"></i>
                <span class="font-bold">Latest</span>
            </div>
            <div class="flex flex-col items-center flex-1 py-6 cursor-pointer border-t hover:bg-emphasis" [ngClass]="{ 'border-primary-500': activeTab === 1, 'surface-border': activeTab !== 1 }" (click)="onTabClick(1)">
                <i class="pi pi-chart-line text-2xl mb-2"></i>
                <span class="font-bold">Trending</span>
            </div>
            <div class="flex flex-col items-center flex-1 py-6 cursor-pointer border-t hover:bg-emphasis" [ngClass]="{ 'border-primary-500': activeTab === 2, 'surface-border': activeTab !== 2 }" (click)="onTabClick(2)">
